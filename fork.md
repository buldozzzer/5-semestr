...
Отметим, что даже с современными операционными системами не существует идеального способа предотвращения вилочной бомбы. Однако применение общих рекомендаций по обеспечению безопасности и предотвращение запуска ненадежного программного обеспечения в корне может заблокировать подавляющее большинство сценариев атак с использованием «вилочных бомб».
